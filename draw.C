...
{/*{{{*/
  ...
  TH1F* hData1 = (TH1F*)fInput->Get("MuMu/Num_Muon");
  hData1->SetFillColor(kRed);
  hData1->SetLineColor(kRed);
  hData1->SetMarkerStyle(21);
  hData1->SetMarkerColor(kRed);
  TH1F* hData2 = (TH1F*)fInput->Get("MuMu/MuSpectrum");
  hData2->SetFillColor(kRed);
  hData2->SetLineColor(kRed);
  hData2->SetMarkerStyle(21);
  hData2->SetMarkerColor(kRed);
  TH1F* hData3 = (TH1F*)fInput->Get("MuMu/MuInvMass");
  hData3->SetFillColor(kRed);
  hData3->SetLineColor(kRed);
  hData3->SetMarkerStyle(21);
  hData3->SetMarkerColor(kRed);
  TH1F* hData4 = (TH1F*)fInput->Get("MuMu/NCleanJetsInMuMu");
  hData4->SetFillColor(kRed);
  hData4->SetLineColor(kRed);
  hData4->SetMarkerStyle(21);
  hData4->SetMarkerColor(kRed);
  ...
  for(int i = 0; i < sampleNames.size(); i++)
  {
    ...
    histVector1.push_back( (TH1F*)fPointer->Get("MuMu/Num_Electron") );
    histVector2.push_back( (TH1F*)fPointer->Get("MuMu/EleInvMass") );
    histVector3.push_back( (TH1F*)fPointer->Get("MuMu/EleSpectrum") );
    histVector4.push_back( (TH1F*)fPointer->Get("MuMu/NCleanJetsInElEl") );
